...
class SolutionMSP{
	...
	public:
		...
		//Funcion que devuelve la bondad de una solucion PARCIAL
		void setAptitude(const vector < vector <int> > &clauses, const int &p1, const int &p2){
